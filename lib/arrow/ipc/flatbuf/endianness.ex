defmodule Arrow.Ipc.Flatbuf.Endianness do
  # Generated from FlatBuffers enum Arrow.Ipc.Flatbuf.Endianness. Do not edit.
  @moduledoc false
  ...
  def __from_json__(name) when is_binary(name) do
    ...
    if atom in all(),
      do: atom,
      else: raise("unknown Arrow.Ipc.Flatbuf.Endianness variant: " <> name)
  end

  def __from_json__(int) when is_integer(int) do
    from_value(int) ||
      raise("unknown Arrow.Ipc.Flatbuf.Endianness value: " <> Integer.to_string(int))
  end
end
